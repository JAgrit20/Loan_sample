            ...
            <main className="page-loan">
                <div className="jumbotron jumbotron-fluid text-dark bg-light animated fadeIn">
                    ...
                    <div className="page-loan__content">
                        ...
                        <div className="form-group row">
                            <label htmlFor="loan-address" className="col-4 col-form-label">address</label>
                            <div className="col-8">
                                <input 
                                    type="address" 
                                    // className={`form-control is-${validation.address.status}`}
                                    name="loan-address" 
                                    id="loan-address" 
                                    placeholder="hauz khas"
                                    onChange={(e) => this.onChangeHandler('loan-address', e.target.value)}
                                    value={loan.address}
                                    />
